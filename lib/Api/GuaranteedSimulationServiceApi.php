<?php
/**
 * GuaranteedSimulationServiceApi
 * PHP version 7.2
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class GuaranteedSimulationServiceApi
{
    /**
     * @var ClientInterface
     */
    ...
    {
        list($response) = $this->guaranteedSimulationServiceAddPostWithHttpInfo($guaranteed_simulation_service_operation);
        return $response;
    }
    ...
    /**
     * Operation guaranteedSimulationServiceAddPostAsync
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedSimulationServiceOperation $guaranteed_simulation_service_operation (optional)
     ...
     */
    public function guaranteedSimulationServiceAddPostAsync($guaranteed_simulation_service_operation = null)
    {
        return $this->guaranteedSimulationServiceAddPostAsyncWithHttpInfo($guaranteed_simulation_service_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation guaranteedSimulationServiceAddPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedSimulationServiceOperation $guaranteed_simulation_service_operation (optional)
     ...
     */
    public function guaranteedSimulationServiceAddPostRequest($guaranteed_simulation_service_operation = null)
    {

        $resourcePath = '/GuaranteedSimulationService/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($guaranteed_simulation_service_operation)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($guaranteed_simulation_service_operation));
            } else {
                $httpBody = $guaranteed_simulation_service_operation;
            }
    ...
    /**
     * Operation guaranteedSimulationServiceGetAdCategoryPost
     *
    ...
    {
        list($response) = $this->guaranteedSimulationServiceGetAdCategoryPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation guaranteedSimulationServiceGetAdCategoryPostWithHttpInfo
     *
    ...
    /**
     * Operation guaranteedSimulationServiceGetAdCategoryPostAsync
     *
     * 
     *
     * @param  object $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function guaranteedSimulationServiceGetAdCategoryPostAsync($body = null)
    {
        return $this->guaranteedSimulationServiceGetAdCategoryPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation guaranteedSimulationServiceGetAdCategoryPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  object $body (optional)
    ...
    /**
     * Create request for operation 'guaranteedSimulationServiceGetAdCategoryPost'
     *
     * @param  object $body (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function guaranteedSimulationServiceGetAdCategoryPostRequest($body = null)
    {

        $resourcePath = '/GuaranteedSimulationService/getAdCategory';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->guaranteedSimulationServiceGetPackagePostWithHttpInfo($guaranteed_simulation_service_package_selector);
        return $response;
    }
    ...
    /**
     * Operation guaranteedSimulationServiceGetPackagePostAsync
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedSimulationServicePackageSelector $guaranteed_simulation_service_package_selector (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function guaranteedSimulationServiceGetPackagePostAsync($guaranteed_simulation_service_package_selector = null)
    {
        return $this->guaranteedSimulationServiceGetPackagePostAsyncWithHttpInfo($guaranteed_simulation_service_package_selector)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation guaranteedSimulationServiceGetPackagePostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedSimulationServicePackageSelector $guaranteed_simulation_service_package_selector (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function guaranteedSimulationServiceGetPackagePostRequest($guaranteed_simulation_service_package_selector = null)
    {

        $resourcePath = '/GuaranteedSimulationService/getPackage';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($guaranteed_simulation_service_package_selector)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($guaranteed_simulation_service_package_selector));
            } else {
                $httpBody = $guaranteed_simulation_service_package_selector;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    {
        list($response) = $this->guaranteedSimulationServiceGetPostWithHttpInfo($guaranteed_simulation_service_selector);
        return $response;
    }
    ...
    /**
     * Operation guaranteedSimulationServiceGetPostAsync
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedSimulationServiceSelector $guaranteed_simulation_service_selector (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function guaranteedSimulationServiceGetPostAsync($guaranteed_simulation_service_selector = null)
    {
        return $this->guaranteedSimulationServiceGetPostAsyncWithHttpInfo($guaranteed_simulation_service_selector)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation guaranteedSimulationServiceGetPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedSimulationServiceSelector $guaranteed_simulation_service_selector (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function guaranteedSimulationServiceGetPostRequest($guaranteed_simulation_service_selector = null)
    {

        $resourcePath = '/GuaranteedSimulationService/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($guaranteed_simulation_service_selector)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($guaranteed_simulation_service_selector));
            } else {
                $httpBody = $guaranteed_simulation_service_selector;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
