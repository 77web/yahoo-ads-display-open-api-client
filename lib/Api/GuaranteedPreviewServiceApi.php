 ...
 * @link     https://openapi-generator.tech
 */
class GuaranteedPreviewServiceApi
{
    /**
     * @var ClientInterface
     */
    ...
    {
        list($response) = $this->guaranteedPreviewServiceGetPostWithHttpInfo($guaranteed_preview_service_selector);
        return $response;
    }
    ...
    /**
     * Operation guaranteedPreviewServiceGetPostAsync
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedPreviewServiceSelector $guaranteed_preview_service_selector (optional)
     ...
     */
    public function guaranteedPreviewServiceGetPostAsync($guaranteed_preview_service_selector = null)
    {
        return $this->guaranteedPreviewServiceGetPostAsyncWithHttpInfo($guaranteed_preview_service_selector)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation guaranteedPreviewServiceGetPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedPreviewServiceSelector $guaranteed_preview_service_selector (optional)
     ...
     */
    public function guaranteedPreviewServiceGetPostRequest($guaranteed_preview_service_selector = null)
    {

        $resourcePath = '/GuaranteedPreviewService/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($guaranteed_preview_service_selector)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($guaranteed_preview_service_selector));
            } else {
                $httpBody = $guaranteed_preview_service_selector;
            }
