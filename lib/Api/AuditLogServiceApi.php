...
class AuditLogServiceApi
{
    ...
    {
        list($response) = $this->auditLogServiceAddPostWithHttpInfo($audit_log_service_operation);
        return $response;
    }
    ...
    /**
     * Operation auditLogServiceAddPostAsync
     *
     * 
     *
     * @param  \OpenAPI\Client\Model\AuditLogServiceOperation $audit_log_service_operation (optional)
     ...
     */
    public function auditLogServiceAddPostAsync($audit_log_service_operation = null)
    {
        return $this->auditLogServiceAddPostAsyncWithHttpInfo($audit_log_service_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation auditLogServiceAddPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \OpenAPI\Client\Model\AuditLogServiceOperation $audit_log_service_operation (optional)
     ...
     */
    public function auditLogServiceAddPostRequest($audit_log_service_operation = null)
    {

        $resourcePath = '/AuditLogService/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function auditLogServiceDownloadPostRequest($audit_log_service_download_selector = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function auditLogServiceGetPostRequest($audit_log_service_selector = null)
    {
