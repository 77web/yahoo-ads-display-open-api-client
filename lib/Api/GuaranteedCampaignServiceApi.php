...
class GuaranteedCampaignServiceApi
{
    ...
    {
        list($response) = $this->guaranteedCampaignServiceGetPostWithHttpInfo($guaranteed_campaign_service_selector);
        return $response;
    }
    ...
    /**
     * Operation guaranteedCampaignServiceGetPostAsync
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedCampaignServiceSelector $guaranteed_campaign_service_selector (optional)
     ...
     */
    public function guaranteedCampaignServiceGetPostAsync($guaranteed_campaign_service_selector = null)
    {
        return $this->guaranteedCampaignServiceGetPostAsyncWithHttpInfo($guaranteed_campaign_service_selector)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation guaranteedCampaignServiceGetPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedCampaignServiceSelector $guaranteed_campaign_service_selector (optional)
     ...
     */
    public function guaranteedCampaignServiceGetPostRequest($guaranteed_campaign_service_selector = null)
    {

        $resourcePath = '/GuaranteedCampaignService/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($guaranteed_campaign_service_selector)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($guaranteed_campaign_service_selector));
            } else {
                $httpBody = $guaranteed_campaign_service_selector;
            }
    ...
    {
        list($response) = $this->guaranteedCampaignServiceSetPostWithHttpInfo($guaranteed_campaign_service_operation);
        return $response;
    }
    ...
    /**
     * Operation guaranteedCampaignServiceSetPostAsync
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedCampaignServiceOperation $guaranteed_campaign_service_operation (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function guaranteedCampaignServiceSetPostAsync($guaranteed_campaign_service_operation = null)
    {
        return $this->guaranteedCampaignServiceSetPostAsyncWithHttpInfo($guaranteed_campaign_service_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation guaranteedCampaignServiceSetPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\GuaranteedCampaignServiceOperation $guaranteed_campaign_service_operation (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function guaranteedCampaignServiceSetPostRequest($guaranteed_campaign_service_operation = null)
    {

        $resourcePath = '/GuaranteedCampaignService/set';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($guaranteed_campaign_service_operation)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($guaranteed_campaign_service_operation));
            } else {
                $httpBody = $guaranteed_campaign_service_operation;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
