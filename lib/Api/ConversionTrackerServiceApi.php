...
class ConversionTrackerServiceApi
{
    ...
    {
        list($response) = $this->conversionTrackerServiceAddPostWithHttpInfo($conversion_tracker_service_operation);
        return $response;
    }
     ...
     */
    public function conversionTrackerServiceAddPostAsync($conversion_tracker_service_operation = null)
    {
        return $this->conversionTrackerServiceAddPostAsyncWithHttpInfo($conversion_tracker_service_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function conversionTrackerServiceAddPostRequest($conversion_tracker_service_operation = null)
    {
        ...
        // for model (json/xml)
        if (isset($conversion_tracker_service_operation)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($conversion_tracker_service_operation));
            } else {
                $httpBody = $conversion_tracker_service_operation;
            }
    ...
    {
        list($response) = $this->conversionTrackerServiceGetPostWithHttpInfo($conversion_tracker_service_selector);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function conversionTrackerServiceGetPostAsync($conversion_tracker_service_selector = null)
    {
        return $this->conversionTrackerServiceGetPostAsyncWithHttpInfo($conversion_tracker_service_selector)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function conversionTrackerServiceGetPostRequest($conversion_tracker_service_selector = null)
    {
        ...
        // for model (json/xml)
        if (isset($conversion_tracker_service_selector)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($conversion_tracker_service_selector));
            } else {
                $httpBody = $conversion_tracker_service_selector;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    {
        list($response) = $this->conversionTrackerServiceSetPostWithHttpInfo($conversion_tracker_service_operation);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function conversionTrackerServiceSetPostAsync($conversion_tracker_service_operation = null)
    {
        return $this->conversionTrackerServiceSetPostAsyncWithHttpInfo($conversion_tracker_service_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function conversionTrackerServiceSetPostRequest($conversion_tracker_service_operation = null)
    {
