...
class FeedFtpServiceApi
{
     ...
     */
    public function feedFtpServiceAddPostRequest($feed_ftp_service_operation = null)
    {
        ...
        if (isset($feed_ftp_service_operation)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($feed_ftp_service_operation));
            } else {
                $httpBody = $feed_ftp_service_operation;
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function feedFtpServiceGetPostRequest($feed_ftp_service_selector = null)
    {
        ...
        if (isset($feed_ftp_service_selector)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($feed_ftp_service_selector));
            } else {
                $httpBody = $feed_ftp_service_selector;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function feedFtpServiceSetPostRequest($feed_ftp_service_operation = null)
    {
