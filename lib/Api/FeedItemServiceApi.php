...
class FeedItemServiceApi
{
     ...
     *
     * @param  \YahooAdsDisplayApi\Client\Model\FeedItemServiceOperation $feed_item_service_operation feed_item_service_operation (optional)
     *
     * @throws \YahooAdsDisplayApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return |\YahooAdsDisplayApi\Client\Model\FeedItemServiceMutateResponse
     */
     ...
     *
     * @param  \YahooAdsDisplayApi\Client\Model\FeedItemServiceOperation $feed_item_service_operation (optional)
     *
     * @throws \YahooAdsDisplayApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of |\YahooAdsDisplayApi\Client\Model\FeedItemServiceMutateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function feedItemServiceSetPostWithHttpInfo($feed_item_service_operation = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\YahooAdsDisplayApi\Client\Model\FeedItemServiceMutateResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\YahooAdsDisplayApi\Client\Model\FeedItemServiceMutateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\YahooAdsDisplayApi\Client\Model\FeedItemServiceMutateResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\YahooAdsDisplayApi\Client\Model\FeedItemServiceMutateResponse',
