...
class FeedDataServiceApi
{
     ...
     */
    public function feedDataServiceDownloadErrorFilePostRequest($feed_data_service_download_error_file_selector = null)
    {
        ...
        if (isset($feed_data_service_download_error_file_selector)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($feed_data_service_download_error_file_selector));
            } else {
                $httpBody = $feed_data_service_download_error_file_selector;
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function feedDataServiceGetPostRequest($feed_data_service_selector = null)
    {
        ...
        if (isset($feed_data_service_selector)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($feed_data_service_selector));
            } else {
                $httpBody = $feed_data_service_selector;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function feedDataServiceUploadPostRequest($account_id, $feed_id, $upload_type, $is_debug, $file = null)
    {
