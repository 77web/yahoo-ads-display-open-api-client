...
class AccountLinkServiceApi
{
    ...
    {
        list($response) = $this->accountLinkServiceGetPostWithHttpInfo($account_link_service_selector);
        return $response;
    }
    ...
    /**
     * Operation accountLinkServiceGetPostAsync
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\AccountLinkServiceSelector $account_link_service_selector (optional)
     ...
     */
    public function accountLinkServiceGetPostAsync($account_link_service_selector = null)
    {
        return $this->accountLinkServiceGetPostAsyncWithHttpInfo($account_link_service_selector)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountLinkServiceGetPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \YahooAdsDisplayApi\Client\Model\AccountLinkServiceSelector $account_link_service_selector (optional)
     ...
     */
    public function accountLinkServiceGetPostRequest($account_link_service_selector = null)
    {

        $resourcePath = '/AccountLinkService/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($account_link_service_selector)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($account_link_service_selector));
            } else {
                $httpBody = $account_link_service_selector;
            }
