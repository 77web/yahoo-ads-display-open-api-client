...
namespace YahooAdsDisplayApi\Client;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://ads-display.yahooapis.jp/api/v4';
    ...
    {
        $report  = 'PHP SDK (YahooAdsDisplayApi\Client) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://ads-display.yahooapis.jp/api/v4",
