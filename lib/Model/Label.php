...
class Label implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets color
     *
     * @param string|null $color <div lang=\"ja\"> カラーです。<br> ADD時およびSET時、このフィールドは省略可能となります。ADD時のデフォルト設定値は#FFFFFFとなります。 </div> <div lang=\"en\"> Color.<br> This field is optional in ADD and SET operation. The default value in ADD operation will be #FFFFFF. </div>
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description <div lang=\"ja\"> 説明文です。<br> ADD時およびSET時、このフィールドは省略可能となります。 </div> <div lang=\"en\"> Description.<br> This field is optional in ADD and SET operation. </div>
     *
     * @return self
     */
     ...
     * Sets label_id
     *
     * @param int|null $label_id <div lang=\"ja\"> ラベルIDです。<br> SET時およびREMOVE時、このフィールドは必須です。 </div> <div lang=\"en\"> Label ID.<br> This field is required in SET and REMOVE operation. </div>
     *
     * @return self
     */
     ...
     * Sets label_name
     *
     * @param string|null $label_name <div lang=\"ja\"> ラベル名です。<br> このフィールドは、ADD時は必須となり、SET時は省略可能となります。 </div> <div lang=\"en\"> Label Name.<br> This field is required in ADD operation, and will be optional in SET operation. </div>
     *
     * @return self
     */
