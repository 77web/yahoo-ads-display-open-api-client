 ...
 */
class FeedDataServiceRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['complete_date'] = $data['complete_date'] ?? null;
        $this->container['error_count'] = $data['error_count'] ?? null;
        $this->container['error_rate'] = $data['error_rate'] ?? null;
        $this->container['feed_id'] = $data['feed_id'] ?? null;
        $this->container['file_upload_src'] = $data['file_upload_src'] ?? null;
        $this->container['file_upload_status'] = $data['file_upload_status'] ?? null;
        $this->container['is_debug'] = $data['is_debug'] ?? null;
        $this->container['item_list_upload_id'] = $data['item_list_upload_id'] ?? null;
        $this->container['item_list_upload_type'] = $data['item_list_upload_type'] ?? null;
