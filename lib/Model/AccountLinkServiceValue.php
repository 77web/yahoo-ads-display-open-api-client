 ...
 */
class AccountLinkServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountLinkServiceValue';
    ...
    {
        $this->container['account_link'] = $data['account_link'] ?? null;
    ...
    {
        return $this->container['account_link'];
    }
     ...
     * @return self
     */
    public function setAccountLink($account_link)
    {
        $this->container['account_link'] = $account_link;
