 ...
 */
class RetargetingListServiceCombinationTargetList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['combinations'] = $data['combinations'] ?? null;
    }
