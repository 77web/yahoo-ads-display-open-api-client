 ...
 */
class AdGroupTargetServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['target_types']) && (count($this->container['target_types']) > 15)) {
            $invalidProperties[] = "invalid value for 'target_types', number of items must be less than or equal to 15.";
        }
    ...
    public function setAdGroupIds($ad_group_ids)
    {
        ...
        if (!is_null($ad_group_ids) && (count($ad_group_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $ad_group_ids when calling AdGroupTargetServiceSelector., number of items must be less than or equal to 1000.');
        }
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling AdGroupTargetServiceSelector., number of items must be less than or equal to 1000.');
        }
    ...
    public function setTargetTypes($target_types)
    {
        ...
        if (!is_null($target_types) && (count($target_types) > 15)) {
            throw new \InvalidArgumentException('invalid value for $target_types when calling AdGroupTargetServiceSelector., number of items must be less than or equal to 15.');
        }
