 ...
 */
class AuditLogServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuditLogServiceValue';
    ...
    {
        $this->container['audit_log_job'] = $data['audit_log_job'] ?? null;
    ...
    {
        return $this->container['audit_log_job'];
    }
     ...
     * @return self
     */
    public function setAuditLogJob($audit_log_job)
    {
        $this->container['audit_log_job'] = $audit_log_job;
