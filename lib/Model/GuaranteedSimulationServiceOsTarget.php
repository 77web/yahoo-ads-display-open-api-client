 ...
 */
class GuaranteedSimulationServiceOsTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GuaranteedSimulationServiceOsTarget';
