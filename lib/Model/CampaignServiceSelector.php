 ...
 */
class CampaignServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['feed_ids']) && (count($this->container['feed_ids']) > 10)) {
            $invalidProperties[] = "invalid value for 'feed_ids', number of items must be less than or equal to 10.";
        }
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling CampaignServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setFeedIds($feed_ids)
    {
        ...
        if (!is_null($feed_ids) && (count($feed_ids) > 10)) {
            throw new \InvalidArgumentException('invalid value for $feed_ids when calling CampaignServiceSelector., number of items must be less than or equal to 10.');
        }
    ...
    public function setLabelIds($label_ids)
    {
        ...
        if (!is_null($label_ids) && (count($label_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $label_ids when calling CampaignServiceSelector., number of items must be less than or equal to 1000.');
        }
    ...
    public function setUserStatuses($user_statuses)
    {
        ...
        if (!is_null($user_statuses) && (count($user_statuses) > 2)) {
            throw new \InvalidArgumentException('invalid value for $user_statuses when calling CampaignServiceSelector., number of items must be less than or equal to 2.');
        }
