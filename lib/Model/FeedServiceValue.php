 ...
 */
class FeedServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['feed'] = $data['feed'] ?? null;
        $this->container['upload_limits'] = $data['upload_limits'] ?? null;
