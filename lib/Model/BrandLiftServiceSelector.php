 ...
 */
class BrandLiftServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandLiftServiceSelector';
    ...
    protected static $setters = [
        ...
        'brand_lift_ids' => 'setBrandLiftIds',
    ...
    protected static $getters = [
        ...
        'brand_lift_ids' => 'getBrandLiftIds',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['brand_lift_ids'] = $data['brand_lift_ids'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['brand_lift_ids']) && (count($this->container['brand_lift_ids']) > 500)) {
            $invalidProperties[] = "invalid value for 'brand_lift_ids', number of items must be less than or equal to 500.";
        }
        ...
        if (!is_null($this->container['approval_statuses']) && (count($this->container['approval_statuses']) > 6)) {
            $invalidProperties[] = "invalid value for 'approval_statuses', number of items must be less than or equal to 6.";
        }
     ...
     * @return int[]|null
     */
    public function getBrandLiftIds()
    {
        return $this->container['brand_lift_ids'];
    }

    /**
     * Sets brand_lift_ids
     *
     * @param int[]|null $brand_lift_ids <div lang=\"ja\">検索条件 : ブランドリフト調査ID</div> <div lang=\"en\">Search Condition: BrandLift ID</div>
     *
     * @return self
     */
    public function setBrandLiftIds($brand_lift_ids)
    {

        if (!is_null($brand_lift_ids) && (count($brand_lift_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $brand_lift_ids when calling BrandLiftServiceSelector., number of items must be less than or equal to 500.');
        }
        $this->container['brand_lift_ids'] = $brand_lift_ids;
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling BrandLiftServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setApprovalStatuses($approval_statuses)
    {
        ...
        if (!is_null($approval_statuses) && (count($approval_statuses) > 6)) {
            throw new \InvalidArgumentException('invalid value for $approval_statuses when calling BrandLiftServiceSelector., number of items must be less than or equal to 6.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 500)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling BrandLiftServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling BrandLiftServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling BrandLiftServiceSelector., must be bigger than or equal to 1.');
        }
