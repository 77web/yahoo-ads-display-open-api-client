...
class AuditLogServiceJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['audit_log_job_end_date'] = $data['audit_log_job_end_date'] ?? null;
        $this->container['audit_log_job_id'] = $data['audit_log_job_id'] ?? null;
        $this->container['audit_log_job_name'] = $data['audit_log_job_name'] ?? null;
        $this->container['audit_log_job_start_date'] = $data['audit_log_job_start_date'] ?? null;
        $this->container['audit_log_job_user_name'] = $data['audit_log_job_user_name'] ?? null;
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling AuditLogServiceJob., number of items must be less than or equal to 500.');
        }
