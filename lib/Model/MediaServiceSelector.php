 ...
 */
class MediaServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setApprovalStatuses($approval_statuses)
    {
        ...
        if (!is_null($approval_statuses) && (count($approval_statuses) > 4)) {
            throw new \InvalidArgumentException('invalid value for $approval_statuses when calling MediaServiceSelector., number of items must be less than or equal to 4.');
        }
    ...
    public function setMediaIds($media_ids)
    {
        ...
        if (!is_null($media_ids) && (count($media_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $media_ids when calling MediaServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setUserStatuses($user_statuses)
    {
        ...
        if (!is_null($user_statuses) && (count($user_statuses) > 2)) {
            throw new \InvalidArgumentException('invalid value for $user_statuses when calling MediaServiceSelector., number of items must be less than or equal to 2.');
        }
