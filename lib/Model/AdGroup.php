...
class AdGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ad_group_bidding_strategy'] = $data['ad_group_bidding_strategy'] ?? null;
        ...
        $this->container['device_os_version'] = $data['device_os_version'] ?? null;
        $this->container['dynamic_image_extensions'] = $data['dynamic_image_extensions'] ?? null;
        $this->container['feed_set_id'] = $data['feed_set_id'] ?? null;
        $this->container['labels'] = $data['labels'] ?? null;
        $this->container['smart_device_carriers'] = $data['smart_device_carriers'] ?? null;
     ...
     * Sets created_date
     *
     * @param string|null $created_date <div lang=\"ja\">広告グループが作成された日時です。<br>※フォーマット：yyyyMMdd</div> <div lang=\"en\">Date of Ad Group made.<br>* Format: yyyyMMdd</div>
     *
     * @return self
     */
