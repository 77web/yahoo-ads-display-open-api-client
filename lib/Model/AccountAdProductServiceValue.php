 ...
 */
class AccountAdProductServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['account_ad_product'] = $data['account_ad_product'] ?? null;
