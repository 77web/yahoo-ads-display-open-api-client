...
/**
 * AccountAuthorityServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AccountAuthorityServiceSelectorオブジェクトは、操作の対象とするアカウント権限を表します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;The AccountAuthorityServiceSelector object displays the account authority for the operations.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AccountAuthorityServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountAuthorityServiceSelector';
    ...
    public function setAccountIds($account_ids)
    {
        ...
        if ((count($account_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $account_ids when calling AccountAuthorityServiceSelector., number of items must be less than or equal to 500.');
        }
        if ((count($account_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_ids when calling AccountAuthorityServiceSelector., number of items must be greater than or equal to 1.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 500)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AccountAuthorityServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AccountAuthorityServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling AccountAuthorityServiceSelector., must be bigger than or equal to 1.');
        }
