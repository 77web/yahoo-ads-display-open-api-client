 ...
 */
class GuaranteedSimulationServicePackageSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GuaranteedSimulationServicePackageSelector';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['package_ids'] = $data['package_ids'] ?? null;
        $this->container['ad_place_types'] = $data['ad_place_types'] ?? null;
        $this->container['device_types'] = $data['device_types'] ?? null;
     ...
     * Sets package_name
     *
     * @param string|null $package_name <div lang=\"ja\">検索条件 : 商品名</div> <div lang=\"en\">Search Condition: Package name</div>
     *
     * @return self
     */
     ...
     * Sets package_ids
     *
     * @param int[]|null $package_ids package_ids
     *
     * @return self
     */
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 10)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling GuaranteedSimulationServicePackageSelector., must be smaller than or equal to 10.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling GuaranteedSimulationServicePackageSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling GuaranteedSimulationServicePackageSelector., must be bigger than or equal to 1.');
        }
