 ...
 */
class CampaignMigrationServiceJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['migration_job_end_date'] = $data['migration_job_end_date'] ?? null;
        $this->container['migration_job_id'] = $data['migration_job_id'] ?? null;
        $this->container['migration_job_submit_date'] = $data['migration_job_submit_date'] ?? null;
        $this->container['scope'] = $data['scope'] ?? null;
        $this->container['succeeded_count'] = $data['succeeded_count'] ?? null;
