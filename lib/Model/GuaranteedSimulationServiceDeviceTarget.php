 ...
 */
class GuaranteedSimulationServiceDeviceTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GuaranteedSimulationServiceDeviceTarget';
