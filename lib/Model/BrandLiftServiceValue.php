 ...
 */
class BrandLiftServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandLiftServiceValue';
    ...
    {
        $this->container['brand_lift'] = $data['brand_lift'] ?? null;
    ...
    {
        return $this->container['brand_lift'];
    }
     ...
     * @return self
     */
    public function setBrandLift($brand_lift)
    {
        $this->container['brand_lift'] = $brand_lift;
