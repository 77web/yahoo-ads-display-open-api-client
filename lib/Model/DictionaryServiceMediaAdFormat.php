 ...
 */
class DictionaryServiceMediaAdFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['ad_format'] = $data['ad_format'] ?? null;
        $this->container['aspect'] = $data['aspect'] ?? null;
        $this->container['aspect_height'] = $data['aspect_height'] ?? null;
        $this->container['aspect_ratio'] = $data['aspect_ratio'] ?? null;
        $this->container['aspect_width'] = $data['aspect_width'] ?? null;
        $this->container['campaign_banner'] = $data['campaign_banner'] ?? null;
        ...
        $this->container['size_to'] = $data['size_to'] ?? null;
        $this->container['static_image'] = $data['static_image'] ?? null;
        $this->container['thumbnail'] = $data['thumbnail'] ?? null;
        $this->container['transparent'] = $data['transparent'] ?? null;
        $this->container['width'] = $data['width'] ?? null;
        $this->container['rich_format'] = $data['rich_format'] ?? null;
    }
     ...
     * Sets ad_format
     *
     * @param string|null $ad_format <div lang=\"ja\"> ディスプレイ（画像）広告のフォーマットです。<br> ※YJ_1350_760, YJ_450_150は予約型広告専用のadFormatとなります。 </div> <div lang=\"en\"> Format of display (image) ads.<br> *YJ_1350_760 and YJ_450_150 are adFormat exclusive for Guaranteed ads. </div>
     *
     * @return self
     */
    ...
    {
        return $this->container['rich_format'];
    }

    /**
     * Sets rich_format
     *
     * @param bool|null $rich_format <div lang=\"ja\">リッチフォーマット用の画像かどうかを示します。</div> <div lang=\"en\">Indicates whether the image is for rich format.</div>
     *
     * @return self
     */
    public function setRichFormat($rich_format)
    {
        $this->container['rich_format'] = $rich_format;
