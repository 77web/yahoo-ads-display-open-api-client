...
class FeedItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['display_settings'] = $data['display_settings'] ?? null;
        $this->container['feed_id'] = $data['feed_id'] ?? null;
        $this->container['formatted_price'] = $data['formatted_price'] ?? null;
        $this->container['formatted_sale_price'] = $data['formatted_sale_price'] ?? null;
        $this->container['in_stock'] = $data['in_stock'] ?? null;
        $this->container['is_remove_capacity'] = $data['is_remove_capacity'] ?? null;
        $this->container['is_remove_formatted_price'] = $data['is_remove_formatted_price'] ?? null;
        $this->container['is_remove_formatted_sale_price'] = $data['is_remove_formatted_sale_price'] ?? null;
        $this->container['is_remove_price'] = $data['is_remove_price'] ?? null;
        $this->container['is_remove_sale_price'] = $data['is_remove_sale_price'] ?? null;
