 ...
 */
class FeedItemServiceMutateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeedItemServiceMutateResponse';
