 ...
 */
class AdGroupTargetServicePositionTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupTargetServicePositionTarget';
