...
class Stats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'video_view_through_rate' => 'setVideoViewThroughRate',
    ...
    protected static $getters = [
        ...
        'video_view_through_rate' => 'getVideoViewThroughRate',
    ...
    {
        $this->container['imps'] = $data['imps'] ?? null;
        $this->container['imps_prev'] = $data['imps_prev'] ?? null;
        $this->container['click_cnt'] = $data['click_cnt'] ?? null;
        $this->container['click_rate'] = $data['click_rate'] ?? null;
        $this->container['click_rate_prev'] = $data['click_rate_prev'] ?? null;
        $this->container['cost'] = $data['cost'] ?? null;
        $this->container['avg_cpc'] = $data['avg_cpc'] ?? null;
        ...
        $this->container['conversion_rate_via_ad_click'] = $data['conversion_rate_via_ad_click'] ?? null;
        $this->container['all_conversions'] = $data['all_conversions'] ?? null;
        $this->container['all_conversion_rate'] = $data['all_conversion_rate'] ?? null;
        $this->container['cpa'] = $data['cpa'] ?? null;
        $this->container['conversion_value'] = $data['conversion_value'] ?? null;
        $this->container['value_per_conversions'] = $data['value_per_conversions'] ?? null;
        $this->container['conv_value_per_cost'] = $data['conv_value_per_cost'] ?? null;
        $this->container['all_conv_value_per_cost'] = $data['all_conv_value_per_cost'] ?? null;
        $this->container['conv_value_via_ad_click_per_cost'] = $data['conv_value_via_ad_click_per_cost'] ?? null;
        $this->container['all_conversion_value'] = $data['all_conversion_value'] ?? null;
        $this->container['value_per_all_conversions'] = $data['value_per_all_conversions'] ?? null;
        $this->container['conversion_value_via_ad_click'] = $data['conversion_value_via_ad_click'] ?? null;
        $this->container['value_per_conversions_via_ad_click'] = $data['value_per_conversions_via_ad_click'] ?? null;
        $this->container['cpa_via_ad_click'] = $data['cpa_via_ad_click'] ?? null;
        $this->container['all_cpa'] = $data['all_cpa'] ?? null;
        $this->container['cross_device_conversions'] = $data['cross_device_conversions'] ?? null;
        $this->container['avg_deliver_rank'] = $data['avg_deliver_rank'] ?? null;
        $this->container['measured_imps'] = $data['measured_imps'] ?? null;
        $this->container['total_vimps'] = $data['total_vimps'] ?? null;
        $this->container['measured_imps_rate'] = $data['measured_imps_rate'] ?? null;
        $this->container['vimps'] = $data['vimps'] ?? null;
        $this->container['viewable_imps_rate'] = $data['viewable_imps_rate'] ?? null;
        $this->container['in_view_rate'] = $data['in_view_rate'] ?? null;
        $this->container['viewable_clicks'] = $data['viewable_clicks'] ?? null;
        $this->container['in_view_click_cnt'] = $data['in_view_click_cnt'] ?? null;
        $this->container['viewable_click_rate'] = $data['viewable_click_rate'] ?? null;
        $this->container['in_view_click_rate'] = $data['in_view_click_rate'] ?? null;
        $this->container['paid_video_views'] = $data['paid_video_views'] ?? null;
        $this->container['paid_video_view_rate'] = $data['paid_video_view_rate'] ?? null;
        $this->container['average_cpv'] = $data['average_cpv'] ?? null;
        $this->container['video_views'] = $data['video_views'] ?? null;
        $this->container['video_views_to25'] = $data['video_views_to25'] ?? null;
        $this->container['video_views_to50'] = $data['video_views_to50'] ?? null;
        $this->container['video_views_to75'] = $data['video_views_to75'] ?? null;
        $this->container['video_views_to95'] = $data['video_views_to95'] ?? null;
        $this->container['video_views_to100'] = $data['video_views_to100'] ?? null;
        $this->container['video_views_to3_sec'] = $data['video_views_to3_sec'] ?? null;
        $this->container['video_views_to10_sec'] = $data['video_views_to10_sec'] ?? null;
        $this->container['average_rate_video_viewed'] = $data['average_rate_video_viewed'] ?? null;
        $this->container['average_duration_video_viewed'] = $data['average_duration_video_viewed'] ?? null;
        $this->container['video_view_through_rate'] = $data['video_view_through_rate'] ?? null;
        $this->container['impression_share'] = $data['impression_share'] ?? null;
        $this->container['budget_impression_share_lost_rate'] = $data['budget_impression_share_lost_rate'] ?? null;
        $this->container['rank_impression_share_lost_rate'] = $data['rank_impression_share_lost_rate'] ?? null;
     ...
     *
     * @param double|null $average_rate_video_viewed <div lang=\"ja\">動画の平均再生率</div> <div lang=\"en\">Avg. video view rate</div>
     *
     * @return self
     */
    ...
    /**
     * Gets video_view_through_rate
     *
     * @return double|null
     */
    public function getVideoViewThroughRate()
    {
        return $this->container['video_view_through_rate'];
    }

    /**
     * Sets video_view_through_rate
     *
     * @param double|null $video_view_through_rate <div lang=\"ja\">動画の再生完了率</div> <div lang=\"en\">Video view through rate</div>
     *
     * @return self
     */
    public function setVideoViewThroughRate($video_view_through_rate)
    {
        $this->container['video_view_through_rate'] = $video_view_through_rate;
