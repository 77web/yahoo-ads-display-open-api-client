 ...
 */
class BudgetOrderServiceReturnValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BudgetOrderServiceReturnValue';
