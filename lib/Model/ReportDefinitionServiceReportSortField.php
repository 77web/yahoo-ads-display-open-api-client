 ...
 */
class ReportDefinitionServiceReportSortField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'field' => 'setField',
        'report_sort_type' => 'setReportSortType'
    ];
    ...
    protected static $getters = [
        'field' => 'getField',
        'report_sort_type' => 'getReportSortType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['report_sort_type'] = $data['report_sort_type'] ?? null;
    }
     ...
     * Sets field
     *
     * @param string|null $field <div lang=\"ja\"> レポート定義のソート対象です。<br> このフィールドは、ADD時に必須となります。 </div> <div lang=\"en\"> Sort object (field) of report definition.<br> This field is required in ADD operation. </div>
     *
     * @return self
     */
    ...
    {
        return $this->container['report_sort_type'];
    }
     ...
     * @return self
     */
    public function setReportSortType($report_sort_type)
    {
        $this->container['report_sort_type'] = $report_sort_type;
