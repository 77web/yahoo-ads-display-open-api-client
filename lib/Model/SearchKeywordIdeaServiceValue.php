 ...
 */
class SearchKeywordIdeaServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchKeywordIdeaServiceValue';
