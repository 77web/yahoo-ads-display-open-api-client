 ...
 */
class GuaranteedSimulationServiceAdRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GuaranteedSimulationServiceAdRequirement';
     ...
     * Sets aspect_ratio
     *
     * @param string|null $aspect_ratio <div lang=\"ja\"> アスペクト比の種類です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\"> Aspect ratio type.<br> Although this field will be returned in the response, it will be ignored on input. </div>
     *
     * @return self
     */
