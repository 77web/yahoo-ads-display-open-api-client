 ...
 */
class LabelServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['number_results'] = $data['number_results'] ?? 2000;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['label_ids']) && (count($this->container['label_ids']) > 2000)) {
            $invalidProperties[] = "invalid value for 'label_ids', number of items must be less than or equal to 2000.";
        }
    ...
    public function setLabelIds($label_ids)
    {
        ...
        if (!is_null($label_ids) && (count($label_ids) > 2000)) {
            throw new \InvalidArgumentException('invalid value for $label_ids when calling LabelServiceSelector., number of items must be less than or equal to 2000.');
        }
