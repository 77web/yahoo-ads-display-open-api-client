 ...
 */
class AdGroupAdServiceManualCPCAdGroupAdBid implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupAdServiceManualCPCAdGroupAdBid';
     ...
     * Sets max_cpc
     *
     * @param int|null $max_cpc <div lang=\"ja\"> 入札価格です。<br> このフィールドは、ADD時は必須となり、SET時は省略可能となります。 </div> <div lang=\"en\"> Bid amount.<br> This field is required in ADD operation, and will be optional in SET operation. </div>
     *
     * @return self
     */
