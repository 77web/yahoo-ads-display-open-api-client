...
/**
 * FeedFtpServicePage Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;FeedFtpServicePageオブジェクトは、取得されるアップロード情報を保持します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;FeedFtpServicePage object retains the Upload information.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class FeedFtpServicePage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeedFtpServicePage';
     ...
     *
     * @param int|null $total_num_entries <div lang=\"ja\">取得される項目の総件数</div> <div lang=\"en\">Total number of entries in the result.</div>
     *
     * @return self
     */
