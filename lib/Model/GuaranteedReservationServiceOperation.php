 ...
 */
class GuaranteedReservationServiceOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GuaranteedReservationServiceOperation';
    ...
    public function setOperand($operand)
    {
        ...
        if ((count($operand) > 1)) {
            throw new \InvalidArgumentException('invalid value for $operand when calling GuaranteedReservationServiceOperation., number of items must be less than or equal to 1.');
        }
        if ((count($operand) < 1)) {
            throw new \InvalidArgumentException('invalid length for $operand when calling GuaranteedReservationServiceOperation., number of items must be greater than or equal to 1.');
        }
