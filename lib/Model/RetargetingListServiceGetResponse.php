 ...
 */
class RetargetingListServiceGetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RetargetingListServiceGetResponse';
