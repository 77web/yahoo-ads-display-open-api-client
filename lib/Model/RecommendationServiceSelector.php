 ...
 */
class RecommendationServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecommendationServiceSelector';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['types']) > 5)) {
            $invalidProperties[] = "invalid value for 'types', number of items must be less than or equal to 5.";
        }

        if ((count($this->container['types']) < 1)) {
    ...
    public function setTypes($types)
    {
        ...
        if ((count($types) > 5)) {
            throw new \InvalidArgumentException('invalid value for $types when calling RecommendationServiceSelector., number of items must be less than or equal to 5.');
        }
        if ((count($types) < 1)) {
            throw new \InvalidArgumentException('invalid length for $types when calling RecommendationServiceSelector., number of items must be greater than or equal to 1.');
        }
