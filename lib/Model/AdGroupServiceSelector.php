...
class AdGroupServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'ad_group_ids' => 'int[]',
        'campaign_goal_filter_type' => '\YahooAdsDisplayApi\Client\Model\AdGroupServiceCampaignGoalFilterType',
        'campaign_ids' => 'int[]',
        ...
        'number_results' => 'int',
        'start_index' => 'int',
        'user_statuses' => '\YahooAdsDisplayApi\Client\Model\AdGroupServiceUserStatus[]',
        'created_date_range' => '\YahooAdsDisplayApi\Client\Model\AdGroupServiceCreatedDateRange'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['feed_set_ids']) && (count($this->container['feed_set_ids']) > 200)) {
            $invalidProperties[] = "invalid value for 'feed_set_ids', number of items must be less than or equal to 200.";
        }
    ...
    public function setAdGroupIds($ad_group_ids)
    {
        ...
        if (!is_null($ad_group_ids) && (count($ad_group_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $ad_group_ids when calling AdGroupServiceSelector., number of items must be less than or equal to 500.');
        }
     ...
     *
     * @return \YahooAdsDisplayApi\Client\Model\AdGroupServiceCampaignGoalFilterType|null
     */
     ...
     *
     * @param \YahooAdsDisplayApi\Client\Model\AdGroupServiceCampaignGoalFilterType|null $campaign_goal_filter_type campaign_goal_filter_type
     *
     * @return self
     */
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling AdGroupServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setFeedSetIds($feed_set_ids)
    {
        ...
        if (!is_null($feed_set_ids) && (count($feed_set_ids) > 200)) {
            throw new \InvalidArgumentException('invalid value for $feed_set_ids when calling AdGroupServiceSelector., number of items must be less than or equal to 200.');
        }
     ...
     * Sets user_statuses
     *
     * @param \YahooAdsDisplayApi\Client\Model\AdGroupServiceUserStatus[]|null $user_statuses user_statuses
     *
     * @return self
     */
     ...
     *
     * @return \YahooAdsDisplayApi\Client\Model\AdGroupServiceCreatedDateRange|null
     */
     ...
     *
     * @param \YahooAdsDisplayApi\Client\Model\AdGroupServiceCreatedDateRange|null $created_date_range created_date_range
     *
     * @return self
     */
