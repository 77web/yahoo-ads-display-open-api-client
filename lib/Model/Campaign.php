...
class Campaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'campaign_delivery_type' => 'setCampaignDeliveryType',
    ...
    protected static $getters = [
        ...
        'campaign_delivery_type' => 'getCampaignDeliveryType',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ad_product_type'] = $data['ad_product_type'] ?? null;
        $this->container['app_id'] = $data['app_id'] ?? null;
        $this->container['app_name'] = $data['app_name'] ?? null;
        $this->container['bidding_strategy'] = $data['bidding_strategy'] ?? null;
        ...
        $this->container['conversion_optimizer'] = $data['conversion_optimizer'] ?? null;
        $this->container['device_os_type'] = $data['device_os_type'] ?? null;
        $this->container['end_date'] = $data['end_date'] ?? null;
        $this->container['feed_id'] = $data['feed_id'] ?? null;
        $this->container['frequency_cap'] = $data['frequency_cap'] ?? null;
        ...
        $this->container['campaign_delivery_type'] = $data['campaign_delivery_type'] ?? null;
     ...
     *
     * @param string|null $ad_product_type <div lang=\"ja\"> 配信方法です。<br> ADD時、このフィールドは指定できません。<br> REMOVE時、このフィールドは無視されます。 </div> <div lang=\"en\"> Ad product information.<br> In ADD operation, this field can not be set. <br> In REMOVE operation, this field will be ignored. </div>
     *
     * @return self
     */
    ...
    /**
     * Gets campaign_delivery_type
     *
     * @return string|null
     */
    public function getCampaignDeliveryType()
    {
        return $this->container['campaign_delivery_type'];
    }

    /**
     * Sets campaign_delivery_type
     *
     * @param string|null $campaign_delivery_type <div lang=\"ja\"> キャンペーン掲載タイプです。<br> このフィールドは、ADDおよびSET時に省略可能となり、REMOVE時に無視されます。<br> CampaignDeliveryTypeを指定してのキャンペーン作成は、一部の利用者向けの機能となります。 </div> <div lang=\"en\"> Campaign delivery type.<br> This field is optional in ADD and SET operation, and will be ignored in REMOVE operation.<br> Creating a campaign with the CampaignDeliveryType specified is a function for some users. </div>
     *
     * @return self
     */
    public function setCampaignDeliveryType($campaign_delivery_type)
    {
        $this->container['campaign_delivery_type'] = $campaign_delivery_type;
     ...
     * Sets created_date
     *
     * @param string|null $created_date <div lang=\"ja\">キャンペーンが作成された日時です。<br>※フォーマット：yyyyMMdd</div> <div lang=\"en\">Date of Campaign made.<br>* Format: yyyyMMdd</div>
     *
     * @return self
     */
