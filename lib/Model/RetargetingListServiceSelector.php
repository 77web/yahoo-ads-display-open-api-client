 ...
 */
class RetargetingListServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RetargetingListServiceSelector';
    ...
    protected static $openAPIFormats = [
        ...
        'target_list_types' => null,
        'sharing_status_filter_type' => null
    ];
    ...
    protected static $setters = [
        ...
        'target_list_types' => 'setTargetListTypes',
        'sharing_status_filter_type' => 'setSharingStatusFilterType'
    ];
    ...
    protected static $getters = [
        ...
        'target_list_types' => 'getTargetListTypes',
        'sharing_status_filter_type' => 'getSharingStatusFilterType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['target_list_ids'] = $data['target_list_ids'] ?? null;
        $this->container['target_list_types'] = $data['target_list_types'] ?? null;
        $this->container['sharing_status_filter_type'] = $data['sharing_status_filter_type'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['target_list_ids']) && (count($this->container['target_list_ids']) > 1000)) {
            $invalidProperties[] = "invalid value for 'target_list_ids', number of items must be less than or equal to 1000.";
        }

        if (!is_null($this->container['target_list_types']) && (count($this->container['target_list_types']) > 5)) {
            $invalidProperties[] = "invalid value for 'target_list_types', number of items must be less than or equal to 5.";
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 1000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling RetargetingListServiceSelector., must be smaller than or equal to 1000.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling RetargetingListServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling RetargetingListServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int[]|null $target_list_ids <div lang=\"ja\">ターゲットリストIDです。</div> <div lang=\"en\">Target List ID.</div>
     *
     * @return self
     */
    public function setTargetListIds($target_list_ids)
    {
        ...
        if (!is_null($target_list_ids) && (count($target_list_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $target_list_ids when calling RetargetingListServiceSelector., number of items must be less than or equal to 1000.');
        }
    ...
    {
        return $this->container['target_list_types'];
    }
     ...
     * @return self
     */
    public function setTargetListTypes($target_list_types)
    {

        if (!is_null($target_list_types) && (count($target_list_types) > 5)) {
            throw new \InvalidArgumentException('invalid value for $target_list_types when calling RetargetingListServiceSelector., number of items must be less than or equal to 5.');
        }
        $this->container['target_list_types'] = $target_list_types;
    ...
    {
        return $this->container['sharing_status_filter_type'];
    }
     ...
     * @return self
     */
    public function setSharingStatusFilterType($sharing_status_filter_type)
    {
        $this->container['sharing_status_filter_type'] = $sharing_status_filter_type;
