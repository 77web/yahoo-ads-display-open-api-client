...
/**
 * GuaranteedAdGroupAdServiceSelector Class Doc Comment
 *
 * @category Class
 ...
 */
class GuaranteedAdGroupAdServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GuaranteedAdGroupAdServiceSelector';
    ...
    protected static $setters = [
        ...
        'ad_group_ad_ids' => 'setAdGroupAdIds',
    ...
    protected static $getters = [
        ...
        'ad_group_ad_ids' => 'getAdGroupAdIds',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ad_group_ad_ids'] = $data['ad_group_ad_ids'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ad_group_ad_ids']) && (count($this->container['ad_group_ad_ids']) > 500)) {
            $invalidProperties[] = "invalid value for 'ad_group_ad_ids', number of items must be less than or equal to 500.";
        }
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling GuaranteedAdGroupAdServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setAdGroupIds($ad_group_ids)
    {
        ...
        if (!is_null($ad_group_ids) && (count($ad_group_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $ad_group_ids when calling GuaranteedAdGroupAdServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    /**
     * Gets ad_group_ad_ids
     *
     * @return int[]|null
     */
    public function getAdGroupAdIds()
    {
        return $this->container['ad_group_ad_ids'];
    }

    /**
     * Sets ad_group_ad_ids
     *
     * @param int[]|null $ad_group_ad_ids <div lang=\"ja\">検索条件 : 広告ID</div> <div lang=\"en\">Search Condition: Ad ID</div>
     *
     * @return self
     */
    public function setAdGroupAdIds($ad_group_ad_ids)
    {

        if (!is_null($ad_group_ad_ids) && (count($ad_group_ad_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $ad_group_ad_ids when calling GuaranteedAdGroupAdServiceSelector., number of items must be less than or equal to 500.');
        }
        $this->container['ad_group_ad_ids'] = $ad_group_ad_ids;
    ...
    public function setLabelIds($label_ids)
    {
        ...
        if (!is_null($label_ids) && (count($label_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $label_ids when calling GuaranteedAdGroupAdServiceSelector., number of items must be less than or equal to 1000.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 500)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling GuaranteedAdGroupAdServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling GuaranteedAdGroupAdServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling GuaranteedAdGroupAdServiceSelector., must be bigger than or equal to 1.');
        }
