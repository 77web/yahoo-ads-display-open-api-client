 ...
 */
class ReportDefinitionServiceGetReportFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportDefinitionServiceGetReportFields';
