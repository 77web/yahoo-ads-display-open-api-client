<?php
/**
 * AdGroupTargetServiceSearchTarget
 *
 * PHP version 7.2
 *
 * @category Class
 ...
 */
class AdGroupTargetServiceSearchTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupTargetServiceSearchTarget';
     ...
     *
     * @param string|null $search_keyword_list_name <div lang=\"ja\"> サーチキーワードリスト名です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\"> Search Keyword List name.<br> Although this field will be returned in the response, it will be ignored on input. </div>
     *
     * @return self
     */
