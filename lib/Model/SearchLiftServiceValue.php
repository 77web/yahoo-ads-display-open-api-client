 ...
 */
class SearchLiftServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchLiftServiceValue';
    ...
    {
        $this->container['search_lift'] = $data['search_lift'] ?? null;
    ...
    {
        return $this->container['search_lift'];
    }
     ...
     * @return self
     */
    public function setSearchLift($search_lift)
    {
        $this->container['search_lift'] = $search_lift;
