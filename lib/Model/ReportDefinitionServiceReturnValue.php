 ...
 */
class ReportDefinitionServiceReturnValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportDefinitionServiceReturnValue';
