 ...
 */
class GuaranteedSimulationServiceAdScheduleTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GuaranteedSimulationServiceAdScheduleTarget';
     ...
     * Sets end_hour
     *
     * @param int|null $end_hour <div lang=\"ja\"> 終了時間（時のみ）です。<br> このフィールドは、ADD時は必須となります。 </div> <div lang=\"en\"> End time (hour only).<br> This field is required in ADD operation. </div>
     *
     * @return self
     */
     ...
     * Sets start_hour
     *
     * @param int|null $start_hour <div lang=\"ja\"> 開始時間（時のみ）です。<br> このフィールドは、ADD時は必須となります。 </div> <div lang=\"en\"> Start time (hour only).<br> This field is required in ADD operation. </div>
     *
     * @return self
     */
